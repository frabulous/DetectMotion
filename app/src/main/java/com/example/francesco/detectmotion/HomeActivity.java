...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnDebug).setOnTouchListener(mDelayHideTouchListener);
    ...
    public void onClick(View view) {
        ...
        if(id == R.id.btnDebug){
            ...
            Bundle b = new Bundle();
            b.putString("game_mode", "TuToRiAl");
            intent.putExtras(b);
            startActivity(intent);
        }
        if(id == btnPractice.getId()){
            Intent intent = new Intent(this, PracticeModeActivity.class);
            Bundle b = new Bundle();
            b.putString("game_mode", "practice mode");
            intent.putExtras(b);
            startActivity(intent);
        }
    }
